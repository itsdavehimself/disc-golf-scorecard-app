...
export default function CourseCard({ course, searchValueInput }) {
  return (
    ...
    >
      <main className="w-full bg-white border-b border-white-smoke pb-3 lg:w-80 lg:border-none">
        <header>
          <img
        ...
        <section className="flex justify-between items-center pt-1">
        ...
        <section className="flex text-sm py-1 gap-2">
          <div>
